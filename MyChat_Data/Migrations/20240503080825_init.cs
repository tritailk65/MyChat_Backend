    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Xin Chao", 5, "Hackathon", null, new DateTime(2024, 5, 3, 15, 8, 25, 514, DateTimeKind.Local).AddTicks(5283) },
                    { 2, "Xin Chao", 5, "Web2", null, new DateTime(2024, 5, 3, 15, 8, 25, 514, DateTimeKind.Local).AddTicks(5299) },
                    { 3, "Xin Chao", 5, "Android 2", null, new DateTime(2024, 5, 3, 15, 8, 25, 514, DateTimeKind.Local).AddTicks(5305) }
                });

            migrationBuilder.InsertData(
                table: "UserRole",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "8ded65cd-123e-4c00-af02-1fafb99f13a2", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, new DateTime(2002, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "65b697d6-3a69-41f9-8a73-44e333d7d495", "admin@gmail.com", true, "admin", "admin", false, null, "admin@gmail.com", "admin", "AQAAAAEAACcQAAAAEIGBZBmNlLqQP20DdsUDD2dfHhJGFSj6hXdOrxjjhzxTnJoRNja2NHnWCLywaS+TNw==", "0765184992", false, "", true, false, "admin", new DateTime(2024, 5, 3, 15, 8, 25, 515, DateTimeKind.Local).AddTicks(8250) });
